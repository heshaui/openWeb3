...
contract MultiSigWallet {
    ...
    // 事件
    event Deposit(address indexed sender, uint256 amount); // 存款
    event Submit(uint256 indexed txId); // 提交
    event Approve(address indexed owner, uint256 indexed txId); // 批准
    event Revoke(address indexed owner, uint256 indexed txId); // 撤销
